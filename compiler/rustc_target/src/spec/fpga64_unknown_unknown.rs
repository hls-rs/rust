...
//
// data_layout mirrors FPGATargetMachine::computeDataLayout for 64-bit mode.
...
pub fn target() -> Target {
    Target {
        llvm_target: "fpga64-unknown-unknown".to_string(),
        pointer_width: 64,
        data_layout: "e-m:e-\
